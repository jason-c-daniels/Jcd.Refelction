...
public class NumericExtensionsTests
{
   ...
   public static void IsIntegerType_WhenGivenIntegerData_ReturnsTrue(object self) { Assert.True(self.IsIntegerType()); }
   ...
   public void IsDecimalType_WhenGivenNonDecimalData_ReturnsFalse(object self) { Assert.False(self.IsDecimalType()); }
   ...
   public void IsNumericType_WhenGivenNonNumericData_ReturnsFalse(object self) { Assert.False(self.IsNumericType()); }
   ...
   [MemberData(nameof(NumericMemberDataProvider.UInt32List), MemberType = typeof(NumericMemberDataProvider))]
   [MemberData(nameof(NumericMemberDataProvider.UInt64List), MemberType = typeof(NumericMemberDataProvider))]
   public void IsBigIntegerType_When_Given_NonBigIntegers_Returns_False(object bi)
   {
      Assert.False(bi.IsBigIntegerType());
   }
