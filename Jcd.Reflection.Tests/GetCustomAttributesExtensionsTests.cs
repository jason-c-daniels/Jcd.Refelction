...
namespace Jcd.Reflection.Tests
{
    public class GetCustomAttributesExtensionsTests
    {
        ...
        public void GetCustomAttributes_For_Enum_Value_Gets_The_Attributes_When_They_Exist(AttributesEnum value, int expectedCount)
        {
        ...
        public void GetCustomAttributes_For_FieldInfo_Gets_The_Attributes_When_They_Exist(Type type, string field, int expectedCount)
        {
            var attrs = type.GetField(field,BindingFlags.Instance| BindingFlags.NonPublic).GetCustomAttributes<MyDescriptionAttribute>();
            Assert.Equal(expectedCount, attrs.Length);
        }
        
        [Theory]
        [InlineData(typeof(AttributesReflectionTestClass), "PrivateProperty", 2)]
        public void GetCustomAttributes_For_PropertyInfo_Gets_The_Attributes_When_They_Exist(Type type, string propName, int expectedCount)
        {
            var attrs = type.GetProperty(propName,BindingFlags.Instance| BindingFlags.NonPublic).GetCustomAttributes<MyDescriptionAttribute>();
            Assert.Equal(expectedCount, attrs.Length);
        }
        ...
        public void GetCustomAttributes_For_MethodInfo_Gets_The_Attributes_When_They_Exist(Type type, string methodName, int expectedCount)
        {
        ...
        public void GetCustomAttributes_For_EventInfo_Gets_The_Attributes_When_They_Exist(Type type, string methodName, int expectedCount)
        {
        ...
        public void GetCustomAttributes_For_ParameterInfo_Gets_The_Attributes_When_They_Exist(Type type, string methodName, string paramName, int expectedCount)
        {
