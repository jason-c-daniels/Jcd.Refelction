...
public static class CustomAttributeHandlingExtensions
{
    ...
    /// <returns>An array of located <typeparamref name="TAttribute"/> instances. If none are found, an empty array is returned.</returns>
    ...
    /// <param name="inherit">inspect the inheritance hierarchy</param>
    /// <typeparam name="TAttribute">The type of attributes to retrieve</typeparam>
    /// <returns>An array of located <typeparamre name="TAttribute"/> instances. If none are found, an empty array is returned.</returns>
