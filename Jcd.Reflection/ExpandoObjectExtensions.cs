...
public static class ExpandoObjectExtensions
{
                                                ...
                                                Func<string, object, bool> valueRetentionStrategy = null)
    {
        ...
        {
            return DefaultExpandoKeyRenamingStrategy(keyRenamingStrategy is { } ? keyRenamingStrategy(key) : key);
        }
        ...
        where TNode : IDictionary<string, object>, new()
    {
        ...
        foreach (var item in enumerable)
        {
            ...
            if (isKeyValuePair is { } && isKeyValuePair.Value)
            {
        ...
        if (isKeyValuePair is { } && isKeyValuePair.Value) return false;
        array = list.ToArray();
        return true;
    }
